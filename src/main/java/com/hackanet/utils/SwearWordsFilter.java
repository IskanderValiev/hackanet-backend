...
public class SwearWordsFilter {
    ...
    private static void loadConfigs() {
        try {
            ...
            InputStreamReader in = new InputStreamReader(url.openConnection().getInputStream());
    ...
    private static List<String> badWordsFound(String input) {
        if (input == null) {
        ...
        for (String s : badWords) {
            log.info("\"" + s + "\" qualified as a bad word");
        }
        return badWords;
    }
